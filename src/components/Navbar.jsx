  ...
  return (
    <header className="w-full py-6">
      <div className="container flex items-center justify-between">
        <a href="#hero" className="px-3 py-2 rounded-md bg-slate-900/40 border border-cyan-500/30 text-sm font-medium tracking-wide">[ SANTHOSH VEMULURI ]</a>
        ...
        <div className="hidden md:block">
          <a href="/resume.pdf" className="px-4 py-2 rounded-full border border-cyan-400 text-cyan-400 hover:bg-cyan-400 hover:text-black text-sm font-semibold">MY RESUME</a>
        </div>
      </div>
    </header>
  )
