    ...
    <section id="contact" className="px-6 py-20 md:py-28">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-12 text-center">
          <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="inline-block px-8 py-3 rounded-md bg-cyanAccent text-black font-bold">DOWNLOAD RESUME</a>
        </div>
      </div>
    </section>
  )
